require=(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"vHBCeV":[function(require,module,exports){
module.exports = {"baseUrl":"http://test.resources.huygens.knaw.nl/womenwriters","facetedSearchBaseUrl":"http://test.resources.huygens.knaw.nl/womenwriters/api"}
},{}],"config/config.yaml":[function(require,module,exports){
module.exports=require('vHBCeV');
...
},{"backbone":9,"jquery":11,"underscore":12}],9:[function(require,module,exports){
//     Backbone.js 1.1.1
...
typeMap = function(typeStr) {
  var fieldType, listType, nestedTypes, simpleTypes;
  simpleTypes = {
    String: 'Text',
    boolean: 'Radio'
  };
  ...
  fieldType = {};
  if (typeStr in simpleTypes) {
    fieldType.type = simpleTypes[typeStr];
  } else {
    fieldType.type = 'Text';
  }
  if (typeStr === 'boolean') {
    fieldType.options = ['Yes', 'No'];
  } else if (listType = String(typeStr).match(/List of \(([^)]+)\)/)) {
    fieldType.type = 'List';
    fieldType.itemType = listType[1];
    fieldType.options = [];
  }
  return fieldType;
};
...
module.exports = {
  createTimbuctooSchema: function(model, options) {
    ...
    for (_i = 0, _len = keys.length; _i < _len; _i++) {
      ...
      _.extend(schema[key], typeMap(model[key]));
    }
    return schema;
  }
};
...
},{"underscore":12}],14:[function(require,module,exports){
var Backbone, EditForm, _,
...
module.exports = EditForm = (function(_super) {
  ...
  EditForm.prototype.initialize = function(options) {
    ...
    this.form = new Backbone.Form(options);
    return this.render();
  };
...
},{"backbone":9,"backbone-forms/distribution/backbone-forms":8,"underscore":12}],15:[function(require,module,exports){
var $, App, Backbone;
...
},{"./views/app.coffee":17,"backbone":3,"jquery":7}],16:[function(require,module,exports){
var Backbone, Config,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
Config = (function(_super) {
  ...
  Config.prototype.defaults = require('config/config.yaml');

  Config.prototype.personURL = function(id) {
    return this.get('facetedSearchBaseUrl') + ("/domain/wwpersons/" + id);
  };
...
},{"backbone":3,"config/config.yaml":"vHBCeV"}],17:[function(require,module,exports){
var $, AppView, Backbone, Form, baseTemplate, config, createTimbuctooSchema, personDescription,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = AppView = (function(_super) {
  ...
  AppView.prototype.template = baseTemplate;
  ...
  AppView.prototype.render = function() {
    ...
    return xhr.done((function(_this) {
      return function(data) {
        var form, key, schema, val;
        schema = {};
        for (key in personDescription) {
          val = personDescription[key];
          if (!key.match(/^\^/)) {
            schema[key] = 'Text';
          }
        }
        ...
        return _this.$('.form').html(form.el);
      };
    })(this));
  };
...
},{"../../data/wwperson.json":18,"../../templates/views/base.jade":19,"../models/config.coffee":16,"backbone":3,"jquery":7,"timbuctoo-edit-forms/src/coffee/helpers.coffee":13,"timbuctoo-edit-forms/src/coffee/views/form.coffee":14}],18:[function(require,module,exports){
module.exports=module.exports = {
  ...
  "livedIn" : "String",
  "^created" : "Change",
  "publishing_languages" : "String[]",
  "collaborations" : "List of (String)",
  ...
  "_id" : "String",
  "name" : "PersonName",
  "@relations" : "Map of (String, List of (EntityRef))",
  "gender" : "Gender",
  "birthDate" : "Datable",
  "tempLanguages" : "List of (String)",
  "educations" : "List of (String)",
  "types" : "List of (Type)",
  "^pid" : "String",
  "tempPseudonyms" : "List of (String)",
  "tempFinancialSituation" : "String",
  "links" : "List of (Link)",
  "health" : "String",
  "fsPseudonyms" : "List of (String)",
  "url" : "XURL",
  "tempDeath" : "String",
  "professions" : "String[]",
  "tempBirthPlace" : "String",
  "tempMotherTongue" : "String",
  "nationality" : "String",
  "^rev" : "int",
  "numberOfChildren" : "int",
  "memberships" : "List of (String)",
  "^variations" : "List of (String)",
  "financials" : "List of (String)",
  "notes" : "String",
  "tempPlaceOfBirth" : "List of (String)",
  "^roles" : "List of (Role)",
...
buf.push("<div class=\"container\"><h1>Neww Women Writers Oooh La</h1><div class=\"form\"></div></div>");;return buf.join("");
};
},{"jade/runtime":6}]},{},[15])